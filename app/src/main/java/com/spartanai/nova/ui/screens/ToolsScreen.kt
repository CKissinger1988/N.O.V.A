...
fun ToolsScreen() {
    ...
    Column(modifier = Modifier.fillMaxSize().padding(16.dp).verticalScroll(rememberScrollState())) {
        ...
        ToolCategory("Cloud & K8s Security", Icons.Default.CloudQueue, listOf("KubeRoast", "Burp-MCP", "JSB-Miner"))
        ToolCategory("Credential Harvesting", Icons.Default.Fingerprint, listOf("Harvest Local", "Harvest Remote", "Crypto Harvest"))
        ToolCategory("USB & Hardware", Icons.Default.Usb, listOf("USB Exploit", "USB Monitor", "OTG Bridge"))
        ToolCategory("Defensive Mesh", Icons.Default.Shield, listOf("Shield", "FlashGuard", "Traversal", "Integrity"))
