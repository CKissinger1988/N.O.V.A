...
sealed class Screen(val route: String, val title: String, val icon: ImageVector) {
    ...
    object Spectrum : Screen("spectrum", "Spectrum", Icons.Default.Analytics)
    object Phishing : Screen("phishing", "Phish", Icons.Default.Webhook)
    ...
    companion object {
        val items = listOf(Terminal, WarRoom, Spectrum, AI, Tools)
    }
}
